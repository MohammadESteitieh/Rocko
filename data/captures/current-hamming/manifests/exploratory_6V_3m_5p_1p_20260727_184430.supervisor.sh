...
tell application "System Events"
    activate
    set response to display dialog "Enter the QNX password for the Rocko transmitter." default answer "" with hidden answer buttons {"Cancel", "Run exploratory test"} default button "Run exploratory test" cancel button "Cancel" with title "Rocko transmitter authentication"
...
RUN=exploratory_6V_3m_5p_1p_20260727_184430
